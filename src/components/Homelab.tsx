...
const Homelab: React.FC = () => {
  ...
  const nodes = [
    ...
    { 
      ...
      specs: '8GB RAM | i5-6200U | 256GB SSD',
      icon: Cat,
      baseCpu: 42, 
      baseMemory: 62, 
      pods: 18,
  ...
  const services = [
    ...
    { 
      ...
      metrics: { storage: '2.5TB', files: '45k', shares: 28 },
      color: 'terminal-amber',
      node: 'Sylvester'
    },
    { 
    ...
    { 
      ...
      metrics: { folders: 18, peers: 6, synced: '850GB' },
      color: 'terminal-purple',
      node: 'Lola'
    },
    { 
      ...
      metrics: { pastes: 1250, views: '8.5k', active: 450 },
      color: 'terminal-pink',
      node: 'Tweety'
    },
    { 
